 ...
 * <h3>Release notes</h3>
 * <ul>
 * <li><h4>Version 2.0.0</h4>migration v8</li>
    ...
    return (function(spreadsheet, options, spreadsheetConfig) {
        ...
        plugin.onevent = function(event, worksheet) {        
            if(event == "onselection") {
                ...
                var statusBarInformationElement = getStatusBarInformationElement(worksheet);
        ...
        plugin.init = function(worksheet) {
            plugin.createStatusbar(worksheet);
        }

        /**
         * Create all element of statusbar
         * @memberOf jss_statusbar
         * @param {Worksheet} worksheet - sheet of spreadsheet
         * @returns {undefined}
         */
        plugin.createStatusbar = function (worksheet) {
            var el = worksheet.content;
            ...
            if(!plugin.options.showAddRowButton || worksheet.options.allowInsertRow==false) {
            ...
            // Information Element
            var statusBarInformationElement = document.createElement("div");
        ...
        plugin.generateInformation = function() {
            ...
            var RangeStart = jspreadsheet.helpers.getColumnNameFromCoords(RangeSelection[0],RangeSelection[1]);
            if(RangeSelection[0]!=RangeSelection[2] || RangeSelection[1]!=RangeSelection[3]) {
                var RangeEnd = jspreadsheet.helpers.getColumnNameFromCoords(RangeSelection[2],RangeSelection[3]);
            } else {
                var RangeEnd = "";
            }
            ...
            var tokensUpdate = function(tokens) {
                ...
                var e1 = jspreadsheet.helpers.getCoordsFromColumnName(token[0]);
                var e2 = jspreadsheet.helpers.getCoordsFromColumnName(token[1]);
            ...
            // Set informations
            var statusBarInformationElement = getStatusBarInformationElement(instance);
         ...
         * @returns {HTMLElement}
         */
        function getStatusBarInformationElement(worksheet) {
            if(worksheet == null) {
                worksheet = getCurrentWorksheet();
            }
            
            return worksheet.content.querySelector(".jss_statusbar_information");
        }
